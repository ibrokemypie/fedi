...
Future<List<Item>> getLocalTimeline(Instance instance, String authCode,
  ...
  switch (instance.type) {
    case "misskey":
      {
        statuses = await getMisskeyLocalTimeline(instance, authCode,
...
Future<List> getMisskeyLocalTimeline(Instance instance, String authCode,
    {List<Item> currentStatuses, String sinceId}) async {
  List<Item> newStatuses = new List();
  Map<String, dynamic> params;
  String actionPath = "/api/notes/local-timeline";
