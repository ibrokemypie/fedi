...
getPublicTimeline(Instance instance, String authCode,
  ...
  switch (instance.type) {
    case "misskey":
      {
        statuses = await getMisskeyPublicTimeline(instance, authCode,
...
Future<List> getMisskeyPublicTimeline(Instance instance, String authCode,
    {List<Item> currentStatuses, String sinceId}) async {
  List<Item> newStatuses = new List();
  Map<String, dynamic> params;
  String actionPath = "/api/notes/global-timeline";
